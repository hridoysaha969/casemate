    ...
    <div className="relative mt-20 grid grid-cols-1 lg:grid-cols-3 mb-20 pb-20">
      ...
      >
        ...
        <Rnd
          ...
          className="absolute z-20 border-[3px] border-rose-600"
          lockAspectRatio
                      ...
                      <div className="mt-3 space-y-4">
                        {selectableOptions.map((option) => (
                          <RadioGroup.Option
                            ...
                            className={({ active, checked }) =>
                              cn(
                                "relative cursor-pointer block rounded-lg bg-white px-6 py-4 shadow-sm border-2 border-zinc-200 focus:outline-none ring-0 focus:ring-0 outline-none sm:flex sm:justify-between",
                                {
                                  "border-rose-600": active || checked,
                                }
                              )
                            }
                          >
